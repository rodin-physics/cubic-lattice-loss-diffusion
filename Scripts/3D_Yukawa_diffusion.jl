...
additional_params = [(x, 4000) for x in [10, 15, 20, 30, 40]]
...
for par in params
    ...
    if !isfile("Data/Diffusion/Yukawa_Diffusion_U0$(U0)_λ$(λ)_ħΩT$(ħΩT)_size$(size_x).jld2")
        ...
        save_object(
            "Data/Diffusion/Yukawa_Diffusion_U0$(U0)_λ$(λ)_ħΩT$(ħΩT)_size$(size_x).jld2",
